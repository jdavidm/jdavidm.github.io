...
def replace_student_link(match):
    ...
    return f'''<a href="https://aidelab.arizona.edu/person/{slug}" target="_blank" rel="noopener noreferrer"
...
def replace_intern_link(match):
    ...
    return f'<a href="https://aidelab.arizona.edu/person/{slug}" target="_blank" rel="noopener noreferrer"<span class="badge" style="cursor: pointer;">{name}</span></a>'
